...
//  REQUIRE(db.getAllElementsAt(TableType::PROC_TABLE) ==
//  unordered_set<int>()); REQUIRE(db.getElementAt(TableType::VAR_TABLE, 1) ==
//  ""); REQUIRE(db.getAllElementsAt(TableType::VAR_TABLE) ==
//  unordered_set<int>());
//
